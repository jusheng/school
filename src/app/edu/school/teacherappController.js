...
angular.module('app')
	.controller('teacherappController', ['$rootScope', '$scope', '$timeout', '$http', '$state', 'toaster',
		function($rootScope, $scope, $timeout, $http, $state, toaster) {
			...
			$scope.authorization = function(){
				var l = angular.element(".teacher .select_id").length;
				$scope.record.appId = "";
				var temp = [];
				for (var i = 0; i < l; i++) {
					temp.push(angular.element(".teacher .select_id")[i].value);
				}
