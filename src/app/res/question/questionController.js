...
angular.module('app')
	.controller('questionController', [ '$rootScope', '$scope', '$http','$timeout', '$state','toaster','recordFormat','API','Upload','ngDialog',
	                                function($rootScope, $scope, $http,$timeout, $state,toaster,recordFormat,API,Upload,ngDialog) {
	$scope.title="试题添加"+' ('+$state.params.subject_name+' '+$state.params.grade_name+')';
