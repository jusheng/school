...
$.widget("ui.sortable", $.extend({}, $.ui.mouse, {
	...
	_mouseDrag: function(event) {
		...
		//Set the helper position
		 ...
		 // 限制在view里拖动，避免拖到外面
		 var max_top = $('.lay_grid').height() - parseInt(this.helper[0].style.height);
		 var max_left = $('.lay_grid').width() - parseInt(this.helper[0].style.width);
		console.log('max_left:'+ max_left);	
		 ...
		 if(!this.options.axis || this.options.axis != "y") this.helper[0].style.left = left+'px';
		 if(!this.options.axis || this.options.axis != "x") this.helper[0].style.top = top +'px';
	...
	_mouseStop: function(event, noPropagation) {
		...
		console.log($('.bj').find('.save').length);
		$('.bj').find('.save').click();
		return false;
