...
angular.module('app')
	.controller('emaileditController', [ '$rootScope', '$scope', '$http', '$state', 'API','toaster','ngDialog','$timeout',
	                                function($rootScope, $scope, $http, $state, API,toaster,ngDialog,$timeout) {
	        ...
	        $scope.search=function(){
				...
				API.post('/oa/mail/listOaMailSend?sendType=0',$scope.param,success,error);
