...
angular.module('app')
	.controller('emailreplyController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','API','recordFormat','toaster','$timeout',
			...
			$scope.get_detail = function(id){
				...
				var success = function(result){
					...
					var record = {
						"sendTitle":'回复：'+result.data.inboxTitle,
						"sendContent":'<p><br></p><br><p><p><br><p>------------------ 原始邮件 ------------------<br>'+result.data.inboxContent,
						"sendids":[$scope.sendId],
						"sendnames":[$scope.sendName],
