...
angular.module('app')
	.controller('emailsendedController', [ '$rootScope', '$scope', '$http', '$state','API','toaster','$timeout','ngDialog',
	        ...
	        $scope.search=function(){
				...
				API.post('/oa/mail/listOaMailSend?sendType=1',$scope.param,success,error);
