...
angular.module('app')
	.controller('emailliststarController', [ '$rootScope', '$scope', '$http', '$state','API','toaster','$timeout','ngDialog',
	        ...
	        $scope.search=function(){
				...
				API.post('/oa/mail/listInboxCollection',$scope.param,success,error);
