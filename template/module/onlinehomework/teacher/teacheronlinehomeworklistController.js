...
angular.module('app')
	.controller('teacheronlinehomeworklistController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','$timeout','toaster','API',
    ...
    $scope.send_bj = function(homeworkId,id,title,km_title){
    	...
    	ngDialog.open({
				template:'template/module/onlinehomework/teacher/selectbj.html',
				...
				resolve: {
   	                     deps: ['uiLoad', '$ocLazyLoad', function(uiLoad, $ocLazyLoad) {
   	                     	return uiLoad.load('template/module/onlinehomework/teacher/selectbjController.js').then(function(){
