...
angular.module('app')
	.controller('centredeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "我的校园桌面";
			$scope.desk_name = "centredesk";
			$scope.desk_bj = "centredesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "centredesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 8; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
