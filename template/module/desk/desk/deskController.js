...
angular.module('app')
	.controller('deskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.slide_status = "";

			$scope.app_name = "我的桌面";
			$scope.desk_name = "desk";
			$scope.desk_bj = "desk_bj"; //布局管理器class
			$scope.desk_lay_grid = "desk_lay_grid"; //桌面容器class
			...
			var desk_sign = 1; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
