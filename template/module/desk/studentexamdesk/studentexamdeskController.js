...
angular.module('app')
	.controller('studentexamdeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "考试中心桌面";
			$scope.desk_name = "studentexamdesk";
			$scope.desk_bj = "studentexamdesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "studentexamdesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 10; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
