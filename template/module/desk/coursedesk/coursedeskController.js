...
angular.module('app')
	.controller('coursedeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "排课管理桌面";
			$scope.desk_name = "coursedesk";
			$scope.desk_bj = "coursedesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "coursedesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 17; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
