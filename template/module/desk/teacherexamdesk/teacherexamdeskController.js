...
angular.module('app')
	.controller('teacherexamdeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "考试中心桌面";
			$scope.desk_name = "teacherexamdesk";
			$scope.desk_bj = "teacherexamdesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "teacherexamdesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 9; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
