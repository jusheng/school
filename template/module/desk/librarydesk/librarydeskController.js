...
angular.module('app')
	.controller('librarydeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "图书管理桌面";
			$scope.desk_name = "librarydesk";
			$scope.desk_bj = "librarydesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "librarydesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 15; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
