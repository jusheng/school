...
angular.module('app')
	.controller('studentborrowdeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "图书借阅记录桌面";
			$scope.desk_name = "studentborrowdesk";
			$scope.desk_bj = "studentborrowdesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "studentborrowdesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 16; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
