...
angular.module('app')
	.controller('centreforteacherdeskController', ['$rootScope', '$scope', '$http', '$state','$compile','$timeout','ngDialog','API','toaster','recordFormat',
		function($rootScope, $scope, $http, $state,$compile,$timeout,ngDialog,API,toaster,recordFormat) {

			$scope.app_name = "校园中心桌面";
			$scope.desk_name = "centreforteacherdesk";
			$scope.desk_bj = "centreforteacherdesk_bj"; //布局管理器class
			$scope.desk_lay_grid = "centreforteacherdesk_lay_grid"; //桌面容器class
			...
			var desk_sign = 13; //桌面的标识 （解决多个桌面之间数据干扰）
			var iconapp_obj = {
