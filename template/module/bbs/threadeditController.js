...
angular.module('app')
    .controller('threadeditController', [ '$rootScope', '$scope', '$http', '$state','Upload','$timeout','ngDialog','toaster','API','recordFormat','$compile',
        ...
        if($state.params.id){
         ...
         $scope.submit = function(){
                ...
                var success = function(result){
                    ...
                    $timeout(function(){
                        $state.go('main.bbs.threadlist',{"id":0});
                    },1000);    
                }
                ...
                delete $scope.record.modifyTime;
                delete $scope.record.publishTime;
                $scope.record.bbsId = $scope.record.id;

            
            API.post('/scl/bbs/update',$scope.record,success,error);
