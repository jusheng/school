...
angular.module('app')
	.controller('mythreadlistController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','API','toaster','recordFormat','$timeout',
	...
	$scope.search=function(){
		...
		API.post('/scl/bbs/read/myBbsList',$scope.param,success,error);
