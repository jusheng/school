...
angular.module('app')
	.controller('studentbindController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','$timeout','toaster','API',
    ...
    $scope.get_role = function(){
        ...
        API.post("/user/read/selectStudentUnbindUser",{"userId":$scope.ngDialogData.id},success,error);
