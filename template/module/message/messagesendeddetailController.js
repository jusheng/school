...
angular.module('app')
	.controller('messagesendeddetailController', [ '$rootScope', '$scope', '$http', '$state','API','toaster','$timeout',
		 ...
		 //    $scope.get_receive = function(id){

		 //    	var success = function(result){
		 //            	$scope.record.receiveName = result.data;
		 //            	$scope.$apply();
