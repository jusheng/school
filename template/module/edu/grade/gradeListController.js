...
angular.module('app')
    .controller('gradeListController', ['$rootScope', '$scope', '$http', '$state', 'Upload', 'ngDialog', '$timeout', 'toaster', 'API',
        function ($rootScope, $scope, $http, $state, Upload, ngDialog, $timeout, toaster, API) {
            ...
            $scope.do_del = function(id){
                ...
                //if (id) { //单个删除
                    ...
                    API.post("/grade/delete", {"id": id}, success, error);
                ...
                //     temp.length > 0 && API.post("/grade/delete", {"id": temp.join(",")}, success, error);
                // }
