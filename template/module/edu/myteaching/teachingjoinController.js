...
angular.module('app')
	.controller('teachingjoinController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','API','toaster','recordFormat','$timeout',
	...
	$scope.search=function(){
		...
		API.post('/teaching/activity/read/myJoinList',$scope.param,success,error);
