...
angular.module('app')
	.controller('teachinglistController', [ '$rootScope', '$scope', '$http', '$state','Upload','ngDialog','API','toaster','recordFormat','$timeout',
	...
	$scope.search=function(){
		...
		API.post('/teaching/activity/read/list',$scope.param,success,error);
