...
Calendar.prototype = {
	...
	PreMonth: function(callback) {
		...
		$('.month').find('option[value="'+this.Month+'"]').attr("selected",true);
		$('.year').find('option[value="'+this.Year+'"]').attr("selected",true);
		//create_year(this.Year);
		callback(this.Year);
		//重绘日历 
		this.Draw();
	},
