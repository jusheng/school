...
angular.module('app')
    .controller('studentborrowListController', [ '$rootScope', '$scope', '$http', '$state','$timeout','Upload','ngDialog','toaster','API','recordFormat',
    ...
    $scope.search=function(){
        ...
        API.post('/res/booksBorrowLog/studentPageList',$scope.param,success,error);
